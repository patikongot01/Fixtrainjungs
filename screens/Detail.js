...
const Detail = ({route, props}) => {
  ...
  const handlePressBookmark = () => {
    convertToID();
    fetch('https://shark-app-wblp9.ondigitalocean.app/BookmarkAdd/'+id)
    console.log(id);
    AlertBookmark();
  };
  var id;
  const convertToID = () => { 
    if(route.params.number == 275){
      id = 0;
    }else if(route.params.number == 997){
      id = 1;
    }else if(route.params.number == 283){
      id = 2;
    }else if(route.params.number == 285){
      id = 3;
    }else if(route.params.number == 281){
      id = 4;
    }else if(route.params.number == 367){
      id = 5;
    }else if(route.params.number == 389){
      id = 6;
    }else if(route.params.number == 279){
      id = 7;
    }else if(route.params.number == 277){
      id = 8;
    }else if(route.params.number == 379){
      id = 9;
    }else if(route.params.number == 391){
      id = 10;
    }else if(route.params.number == 371){
      id = 11;
    }else if(route.params.number == 383){
      id = 12;
    }
  }
